...
export const GetLaunchesDocument = `
    query GetLaunches {
...
export const useGetLaunchesQuery = <
      TData = GetLaunchesQuery,
      TError = unknown
    >(
      variables?: GetLaunchesQueryVariables, 
      options?: UseQueryOptions<GetLaunchesQuery, TError, TData>
    ) => 
    useQuery<GetLaunchesQuery, TError, TData>(
      ['GetLaunches', variables],
      fetcher<GetLaunchesQuery, GetLaunchesQueryVariables>(GetLaunchesDocument, variables),
      options
    );